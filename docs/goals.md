...
!!! note "Zielsetzung"
    Dieses Dokument fasst die Lernziele zusammen, die auf Basis der Funktionen von **Logic Traffic** (Wahrheitstabelle, Formeleditor, Simulation) formuliert wurden. Sie wurden sowohl mit dem Lehrplan21[^1] als auch mit dem Rahmenlehrplan Gymnasium[^2] verknüpft, um für alle Schularten Anknüpfungspunkte zu bieten.
    
    Die Einordnung erfolgt entlang der Wissensdimensionen nach **Anderson [^3] (2009)**. Damit werden unterschiedliche Wissens- und Lernbereiche systematisch abgedeckt.
