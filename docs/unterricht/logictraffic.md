...
??? teacher "Ziel der Aufgabe" 
    ...
    Oberfläche kennenlernen, Bedeutungen der Darstellungen klären, erste Einsicht: Ampelsituation ↔ Wahrheitstabelle ↔ Formel.    
...
!!! logictraffic "EA1 - Bedienung und Grundkonzept des Tools aufbauen" 
    ...
    ??? student "Schritt 2 - Beschrifte die Oberfläche"
        Mache einen Screenshot oder zeichne eine Skizze der Oberfläche (hier alternativ als Arbeitsblatt verfügbar: )
...
!!! logictraffic "EA2 - Einführung ins Tool" 
    ...
    ??? student "Schritt 3 - Wir formulieren eine allgemeingültige Regel" 
        ...
        !!! teacher "Besprechung der Sätze im Plenum -> dieser Wechsel von der enaktiven Simulation zur symbolischen Ebene ist anspruchsvoll und braucht eine Besprechung" 
...
!!! logictraffic "Tool Führerschein" 
    !!! teacher "formative Beurteilungsaufgabe" 
        ...
        Dies kann auch durch einen Partnerarbeit geschehen. 
    ...
    ??? student "LogicTraffic Führerschein" 
        Arbeite in deinem eigenen Tempo. Hake ab, was du sicher kannst. Wenn du Hilfe brauchest, markiere die Aufgabe mit einem Fragezeichen
...
!!! logictraffic "Syntheseaufgabe - LogicTraffic in einer Gesamtaufgabe anwenden" 
    !!! danger "bei dieser Aufgabe müssen die Grundlagen des Themas Wahrheitstabellen und für den Schritt 3 auch die der Formlen verstanden sein."
