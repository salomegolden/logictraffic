...
???+ logictraffic "Material pro Gruppe (3–4 Personen): KA1"
    Spielfläche: Ein mit Klebeband auf dem Tisch markiertes Kreuz = Kreuzung mit 4 Einfahrten (N, O, S, W)
    Fahrzeuge: 4 Spielzeugautos
    Pfeilkarten für eine Richtung (gerade, links, rechts)
    Signalkarten: Pro "Fahrspur" ein Set aus einer roten und einer grünen Karte (oder z.B. rote und grüne LEGO-Steine)
