...
??? note "Fachbegriff: Äquivalenz ($\equiv$ bzw. $\sim$)"
...
??? note "Fachbegriff: Aussage (Proposition)"
...
??? note "Fachbegriff: Aussagenvariablen ($A, B, C, \dots$)"
...
??? note "Fachbegriff: Boolesche Algebra"
...
??? note "Fachdidaktik: Informatisches Denken (Computational Thinking)"
...
??? note "Fachdidaktik: Darstellungswechsel (Mehrfachrepräsentationen)"
...
??? note "Fachbegriff: De Morgan'sche Gesetze"
...
??? note "Fachbegriff: Disjunktion ($\lor$ / ODER)"
...
??? note "Fachdidaktik: EIS-Prinzip & Virtuell-enaktive Repräsentation"
...
??? note "Fachdidaktik: Enaktive Repräsentation (handelnd)"
...
??? note "Fachdidaktik: Fundamentale Ideen der Informatik"
...
??? note "Fachdidaktik: Ikonische Repräsentation (bildhaft)"
...
??? note "Fachbegriff: Implikation ($\rightarrow$ / WENN ... DANN)"
...
??? note "Fachdidaktik: Informatische Modellierung & Abstraktion"
...
??? note "Fachbegriff: Kanonische Disjunktive Normalform (KDNF / CDNF)"
...
??? note "Fachbegriff: Kanonische Konjunktive Normalform (KKNF / CCNF)"
...
??? note "Fachbegriff: Konjunktion ($\land$ / UND)"
...
??? note "Fachdidaktik: Kontextorientierung & Lebensweltbezug"
...
??? note "Fachbegriff: Normalform (KNF / DNF / Simplest)"
...
??? note "Fachbegriff: Polizisten-Status (Feedback in LogicTraffic)"
...
??? note "Fachdidaktik: Symbolische Repräsentation (formal-abstrakt)"
...
??? note "Fachdidaktik: Virtuell-enaktive Repräsentation (simulativ-handelnd)"
...
??? note "Fachbegriff: Wahrheitstabelle (Truth Table)"
...
??? note "Fachbegriff: Wahrheitswert ($0$ und $1$)"
