...
!!! student "Konjunktive Normalform" 
    Eine KNF ist eine grosse UND‑Verknüpfung von ODER‑Bedingungen. [^1] [^2]. Jede ODER‑Bedingung beschreibt eine Zeile der Wahrheitstabelle, in der das Ergebnis falsch (0) ist.
